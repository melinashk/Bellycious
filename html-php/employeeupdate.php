        ...
        <div class="bar">
            <ul>
                <span class="cont">
                    ...
                    <li class="active"><a href="employeeupdate.php">Update Staff Info</a></li>
                   ...
                   while($row=mysqli_fetch_assoc($query_run))
                   {
                       echo "
                        <tr>
                                ...
                                <td>".$row['joindate']."</td>
                                <td>".$row['job']."</td>
                                <td><a href = 'eupdate.php?id=$row[id]&name=$row[name]&address=$row[address]&dob=$row[dob]&email=$row[email]&contact=$row[contact]&joindate=$row[joindate]&job=$row[job]'>Update</a> </td>

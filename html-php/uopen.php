...
<body>
    ...
    <form action="" method="POST" target="_self" class="don">
        ...
        <p>Is the restaurant open today?</p><textarea type="text" name="open" placeholder="Type Here" rows="5" cols="10"></textarea><br><br>
        <span><input type="submit" name="send" value="Post"/></span>
    ...
    <?php
        ...
        if(isset($_POST['send']))
        {
            ...
            $query="UPDATE status SET open='$open' WHERE id='$uid'";
